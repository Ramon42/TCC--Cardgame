...
function scr_send_explode(_objeto1, _objeto2){
	...
	buffer_write(con_client.buffer, buffer_u8, _objeto1.inst_id); //inst_id do atacante
	buffer_write(con_client.buffer, buffer_u8, _objeto2.inst_id); //inst_id do defensor
